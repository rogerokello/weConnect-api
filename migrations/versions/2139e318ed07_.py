...
Revision ID: 2139e318ed07
Revises: 9de70334eaca
Create Date: 2018-02-27 21:56:02.547635
...
revision = '2139e318ed07'
down_revision = '9de70334eaca'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('token', sa.String(length=2000), nullable=True),
